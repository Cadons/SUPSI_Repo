  ...
  <#--
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          <ul class="nav navbar-nav">
            ...
            <li <#if selected != "" && selected?lower_case?starts_with("last")>class="active"</#if>>
                <a href="/last">Most visited</a>
            </li>
            <#if sessionUser??>
    ...
    <div class="container">
      ...
      <div class="col-lg-4">
          ...
          <div class="well">
            <h4>Blog</h4>
            <p>Questo è un blog. Ed usa <a href="http://www.mongodb.com">mongoDB</a> e <a href="http://www.redis.io">Redis</a>.</p>
          </div><!-- /well -->
        </div>
      </div>
